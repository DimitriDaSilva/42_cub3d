...
/*   Updated: 2021/02/03 13:07:33 by dda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_player(t_game *game)
{
	...
	game->player.radius = game->scene.mini_map_tile_size / 2;
	circle.x = game->player.x * game->scene.mini_map_tile_size + MINIMAP_OFFSET;
	circle.y = game->player.y * game->scene.mini_map_tile_size + MINIMAP_OFFSET;
	...
	line.begin_x = game->player.x * game->scene.mini_map_tile_size
					+ MINIMAP_OFFSET;
	line.begin_y = game->player.y * game->scene.mini_map_tile_size
					+ MINIMAP_OFFSET;
	line.end_x = game->player.x * game->scene.mini_map_tile_size
					+ MINIMAP_OFFSET
		+ cos(game->player.rotation_angle) * game->scene.mini_map_tile_size;
	line.end_y = game->player.y * game->scene.mini_map_tile_size +
				MINIMAP_OFFSET + sin(game->player.rotation_angle)
				* game->scene.mini_map_tile_size;
